...
### Fixed
- Fixed Python wheel builds by updating to tritter-accel 0.2.2
- tritter-accel now has PyO3 bindings as optional, preventing cdylib linking conflicts

### Dependencies
- tritter-accel = "0.2" (was "0.1")
