...
#[derive(Debug, Clone)]
#[allow(clippy::struct_excessive_bools)] // Intentional: each bool controls independent formatting option
...
pub fn log_training_step(step: usize, total_steps: usize, loss: f64, lr: f64) {
    #[allow(clippy::cast_precision_loss)] // Progress percentage doesn't need full precision
...
pub fn log_memory_usage(allocated_bytes: usize, peak_bytes: usize, context: &str) {
    #[allow(clippy::cast_precision_loss)] // MB display doesn't need byte-level precision
